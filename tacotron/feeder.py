...
class Feeder:
    ...
    def start_threads(self, session):
        ...
        thread_train = threading.Thread(name='background', target=self._enqueue_next_train_group)
        thread_train.daemon = True  # Thread will close when parent quits
        thread_train.start()

        thread_test = threading.Thread(name='background', target=self._enqueue_next_test_group)
        thread_test.daemon = True  # Thread will close when parent quits
        thread_test.start()
        return [thread_train, thread_test]
